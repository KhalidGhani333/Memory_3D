...
export const Route = createFileRoute("/memorials")({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Honor a loved one with a 3D crystal keepsake. A way to hold their memory in your hands forever." },
    ...
    <div className="bg-background">
      <section className="relative min-h-[85vh] flex items-end pt-40 pb-24">
        ...
        <div className="relative max-w-7xl mx-auto px-6 lg:px-10">
          <Reveal>
            <span className="text-[11px] tracking-[0.35em] uppercase text-gold">Memorial Collection</span>
            ...
            <p className="mt-6 text-xl text-muted-foreground max-w-xl font-light">
              For the people, the pets, the lives that left a mark on yours.
              A quiet keepsake that catches the morning light — and your breath, every time.
            </p>
          </Reveal>
        </div>
      </section>
        ...
        <div className="max-w-3xl mx-auto px-6 text-center">
          <Reveal>
            ...
            <p className="mt-6 text-lg text-muted-foreground">
              Upload one cherished photo. We'll craft a quiet, permanent tribute — in crystal that lasts longer than memory.
            </p>
            <Link to="/contact" className="mt-10 inline-flex items-center gap-3 bg-gradient-gold text-primary-foreground px-9 py-4 text-[11px] tracking-[0.3em] uppercase rounded-sm shadow-gold">
